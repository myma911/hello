<template>
	<view class="content" :class="{'active':active}">
		<image class="logo" :class="{'active':active}" src="../../static/img/tabbar/guanzhuactive.png"  mode="aspectFit"></image>
		<view class="tabbar-box-wrap">
			<view class="tabbar-box">
				<view class="tabbar-box-item" @click="goToPage('/pages/add/add-picture')">
					<image class="box-image" src="../../static/img/release.png" mode="aspectFit"></image>
					<text class="explain">发图文</text>
				</view>
				<view class="tabbar-box-item" @click="goToPage('/pages/add/add-video')">
					<image class="box-image" src="../../static/img/video.png" mode="aspectFit"></image>
					<text class="explain">发视频</text>
				</view>
				<view class="tabbar-box-item" @click="goToPage('/pages/add/add-qa')">
